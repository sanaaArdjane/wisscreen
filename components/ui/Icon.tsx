...
const PATHS: Record<IconName, string> = {
  ...
  "eye-off": "M4 4l16 16M10.6 6.2A9.9 9.9 0 0 1 12 6c6.4 0 10 6 10 6a17 17 0 0 1-3.2 3.7M6.3 8.3C3.7 9.9 2 12 2 12s3.6 6 10 6c1.4 0 2.7-.3 3.8-.8M9.9 9.9a3 3 0 0 0 4.2 4.2",
